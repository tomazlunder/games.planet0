...
public class StartBullet extends Entity{
    ...
    public StartBullet(float x, float y, Planet planet, Vector2 directionalUnitVector){
        super(x,y,3, planet);
        ...
        direction = directionalUnitVector;
    }

    @Override
    public void update(float deltaTime) {
        Vector2 newPos = this.center;
        newPos.add(direction.cpy().scl(deltaTime*1000));
        this.center = newPos;
